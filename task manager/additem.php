...
<input type='text' class="input-field" name='task'/></label>

<label for="field2"><span>Description</span>
<textarea class="field-long field-textarea" name='description'/></textarea></label>

<label for="field2"><span>Date</span>
<input type="date" class="input-field" name = "datetodo"></label>

<label for="field1"><span>Time</span>
<input type="time" class="input-field" name="timetodo"></label>
